...
def test_profile_flow():
    ...
    response = requests.put(
        f"{base_url}/profiles/me", json=profile_data, headers=headers
    )
    print(f"Status: {response.status_code}")
    if response.status_code == 200:
    ...
    response = requests.post(
        f"{base_url}/profiles/complete", json=step1_data, headers=headers
    )
    ...
    response = requests.post(
        f"{base_url}/profiles/complete", json=step2_data, headers=headers
    )
    ...
    response = requests.post(
        f"{base_url}/profiles/complete", json=step3_data, headers=headers
    )
    ...
    response = requests.post(
        f"{base_url}/profiles/complete", json=step4_data, headers=headers
    )
    ...
    response = requests.post(
        f"{base_url}/profiles/complete", json=step5_data, headers=headers
    )
