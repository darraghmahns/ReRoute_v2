...
Revision ID: 6f75d3b39f79
Revises: 
Create Date: 2025-07-10 17:19:40.205479
...
def upgrade() -> None:
    ...
    sa.Column('weight_lbs', sa.DECIMAL(precision=5, scale=2), nullable=True),
    sa.Column('height_ft', sa.Integer(), nullable=True),
    sa.Column('height_in', sa.Integer(), nullable=True),
    sa.Column('cycling_experience', sa.String(length=50), nullable=True),
    sa.Column('fitness_level', sa.String(length=50), nullable=True),
    sa.Column('weekly_training_hours', sa.DECIMAL(precision=4, scale=1), nullable=True),
    ...
    sa.Column('time_availability', sa.JSON(), nullable=True),
    sa.Column('training_preferences', sa.JSON(), nullable=True),
    sa.Column('current_fitness_assessment', sa.Text(), nullable=True),
    sa.Column('profile_completed', sa.Boolean(), nullable=True),
    sa.Column('strava_user_id', sa.String(length=255), nullable=True),
